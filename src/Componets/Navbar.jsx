...
function Navbar() {
    return (
        <div className={`{styles.mainNavbar} wrapper`}>
                    ...
                    <div className="container">
                        <div className={`${styles.flagIcons} d-flex justify-content-between`}>
                            ...
                            <div className={`${styles.icons} d-flex`}>
                                <Link to="/" className={`${styles.TopBarIcons} d-flex align-self-center`}>
                        ...
                        <div className={styles.logoCallBtns}>
                            <div className="row">
                                ...
                                <div className={`${styles.buttonsEndCol} col-lg-4 d-flex justify-content-lg-end justify-content-center`}>
                                    <div className={`${styles.userButtons}`}>
                                        <Link to="/" className='d-flex justify-content-center align-items-center'><i className="fa fa-user"></i></Link>
                                    </div>
